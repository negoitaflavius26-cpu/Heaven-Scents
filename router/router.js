...
const { paginaExersare,citesteCategoria, paginaAcasa, paginaLogare, paginaInregistrare, logarePersoana, inregistrarePersoana,paginaBranduri,citesteBrand,uitareParola,emailParola,resetareParola} = require('../controllers/controller');
const modelComanda=require('../modele/modelComanda')

router.get('/home', paginaAcasa);

router.get('/home/exersare',paginaExersare)
