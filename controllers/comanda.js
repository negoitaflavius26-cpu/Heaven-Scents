...
if (error) {
  ...
  try {
    ...
    console.log(error);
    return res.status(500).send('Produsele nu sunt gasite, avem o problema');
  }
...
console.log(estimareLivrare);
    ...
    console.log(error);
    return res.status(500).send('A intervenit o eroare la plasarea comenzii');
  }
};
